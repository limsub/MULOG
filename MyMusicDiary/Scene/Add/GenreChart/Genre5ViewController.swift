...
class Genre5ViewController: BaseViewController {
    
    var delegate: UpdateDataDelegate?
    
    var myGenre = GenreDataModel.shared.genres[4]
...
// prefetch
extension Genre5ViewController: UICollectionViewDataSourcePrefetching {
...
// delegate
extension Genre5ViewController: UICollectionViewDelegate {
